...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['add'])) {
    ...
    print_r($_POST);
    echo "</pre>";
    if (isset($_POST['name'], $_POST['description'], $_POST['image'], $_POST['typee'], $_POST['typee2'], $_POST['madein'], $_POST['brand'], $_POST['price'], $_POST['isnew'])) {
        ...
        $ok = R::exec("INSERT INTO shop_table (name, description, typee_id, typee2_id, madein_id, "
                        . "brand_id, price, is_new, imagee) VALUES (?,?,?,?,?,?,?,?,?);", [$_POST['name'], $_POST['description'],
                    $_POST['typee'], $_POST['typee2'], $_POST['madein'], $_POST['brand'], $_POST['price'], $_POST['isnew'], $_POST['image']]);
        if ($ok) {
